...
void recursiveSquare(Turtle t, float size, int recursionsLeft = 1){
    drawSquare(t, size);
    --recursionsLeft;
    ...
    if (recursionsLeft > 0) {
        ...
        float sizeDec = size / 3;

        /// patrate sus
        Turtle tSS = t; //Stanga sus
        tSS.move(0);
        tSS.rotate(pi / 2);
        tSS.move(size + sizeDec);
        tSS.rotate(pi / 2);
        tSS.move(sizeDec);
        tSS.rotate(-pi / 2);
        
        drawSquare(tSS, sizeDec);


        Turtle tCS = t; //Centru sus
        tCS.move(0);
        tCS.rotate(pi / 2);
        tCS.move(size + sizeDec);
        tCS.rotate(-pi / 2);
        tCS.move(sizeDec);
       
        drawSquare(tCS, sizeDec);


        Turtle tDS = t; //Dreapta sus
        tDS.move(0);
        tDS.rotate(pi / 2);
        tDS.move(size + sizeDec);
        tDS.rotate(-pi / 2);
        tDS.move(5*sizeDec);
        tDS.rotate(pi / 2);

        drawSquare(tDS, sizeDec);


        //mijloc

        Turtle tSM = t; //Stanga mij
        tSM.move(0);
        tSM.rotate(pi / 2);
        tSM.move(size + sizeDec);
        tSM.rotate(pi / 2);
        tSM.move(sizeDec);
        tSM.rotate(pi / 2);
        tSM.move(2 * sizeDec);
        ...
        drawSquare(tSM, sizeDec);


        Turtle tDM = t; //Dreapta mij
        tDM.move(0);
        tDM.rotate(pi / 2);
        tDM.move(size + sizeDec);
        tDM.rotate(-pi / 2);
        tDM.move(5 * sizeDec);
        tDM.rotate(-pi / 2);
        tDM.move(2 * sizeDec);
        ...
        drawSquare(tDM, sizeDec);


        ///patrate jos

        Turtle tSJ = t; //Stanga jos
        tSJ.move(0);
        tSJ.rotate(pi / 2);
        tSJ.move(size + sizeDec);
        tSJ.rotate(pi / 2);
        tSJ.move(sizeDec);
        tSJ.rotate(pi / 2);
        tSJ.move(5 * sizeDec);
        ...
        drawSquare(tSJ, sizeDec);

        Turtle tDJ = t; //Dreapta jos
        tDJ.move(0);
        tDJ.rotate(pi / 2);
        tDJ.move(size + sizeDec);
        tDJ.rotate(-pi / 2);
        tDJ.move(5 * sizeDec);
        tDJ.rotate(-pi / 2);
        tDJ.move(5 * sizeDec);
        ...
        drawSquare(tDJ, sizeDec);


        Turtle tCJ = t; //Centru jos
        tCJ.move(0);
        tCJ.rotate(pi / 2);
        tCJ.move(size + sizeDec);
        tCJ.rotate(-pi / 2);
        tCJ.move(sizeDec);
        tCJ.rotate(-pi/2);
        tCJ.move(6*sizeDec);
        ...
        drawSquare(tCJ, sizeDec);

        if (recursionsLeft > 0) {
            recursiveSquare(tSS, sizeDec, recursionsLeft);
            recursiveSquare(tCS, sizeDec, recursionsLeft);
            recursiveSquare(tDS, sizeDec, recursionsLeft);
            recursiveSquare(tSM, sizeDec, recursionsLeft);
            recursiveSquare(tDM, sizeDec, recursionsLeft);
            recursiveSquare(tSJ, sizeDec, recursionsLeft);
            recursiveSquare(tCJ, sizeDec, recursionsLeft);
            recursiveSquare(tDJ, sizeDec, recursionsLeft);
        }
    }
...
void Display3() {
    ...
    float sizePM = 1.8;
    float sizePInt = sizePM / 3;

    Turtle tPM(-sizePM / 2, -sizePM / 2);

    drawSquare(tPM, sizePM );

    if (g_recursionCurrent) {
        Turtle tPInt(-sizePM / 2 + sizePInt, -sizePM / 2 + sizePInt);

        recursiveSquare(tPInt, sizePInt, g_recursionCurrent);
    }
}


void dawTriaHex(Turtle t, float distance) {
...
void recursiveTrian(Turtle t, float distance, int recursionsLeft = 1) {
    if (recursionsLeft > 0) {
        --recursionsLeft;
